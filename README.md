...
Currently in active development. Backend (auth, properties, bookings) and core frontend auth flow (login/register, protected routes) are complete. Remaining work: styling, and deployment.
